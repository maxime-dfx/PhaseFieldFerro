...
int main(int argc, char** argv) {
    try {
        ...
        Mesh mesh = MeshGeneratorGmsh::load_from_msh("../input/rectangle.msh", config.mesh.Lx, config.mesh.Ly);
        Logger::debug("Mesh initialized successfully.", config.simulation.debug_enabled);

        // 3. Initialiser l'exportateur
